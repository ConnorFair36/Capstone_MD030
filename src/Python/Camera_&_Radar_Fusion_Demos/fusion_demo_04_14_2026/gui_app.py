...
class RosListener:
    def __init__(self, state: AppState):
        ...
        self.subs[6].subscribe(lambda msg: self._setattr("radar_detected", bool(msg.get("data", False)), "radar"))
        self.subs[7].subscribe(lambda msg: self._setattr("radar_distance", float(msg.get("data", 0.0)), "radar"))
        self.subs[8].subscribe(lambda msg: self._setattr("radar_motion", str(msg.get("data", "NONE")), "radar"))
        self.subs[9].subscribe(lambda msg: self._setattr("radar_confidence", float(msg.get("data", 0.0)), "radar"))
        self.subs[10].subscribe(self._on_radar_points)
        self.subs[11].subscribe(lambda msg: self._setattr("vehicle_state", str(msg.get("data", "SAFE")).upper(), "vehicle"))
        self.subs[12].subscribe(self._on_fusion_debug)
