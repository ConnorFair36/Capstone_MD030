# radar_module.py
#
# Provides functions to read radar data from your COM ports.
# Now includes get_radar_data_raw() to get raw points as [x, y, z, velocity]
...
def get_radar_data():
    ...
    while True:
        ...
        return {"distance": mean_y, "motion": motion}

    return None

def get_radar_data_raw():
    """
    Returns raw radar points as a list of [x, y, z, velocity].
    Reads a full frame from the radar if available.
    """
    global buf
