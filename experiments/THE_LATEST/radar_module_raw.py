...
# }
#
# NEW: Also stores last raw point cloud accessible via get_last_raw_points()
#
...
# NEW: Store last raw point cloud
last_raw_points = {
    "x": [],
    "y": [],
    "z": [],
...
def get_radar_data():
    ...
    Also updates the global last_raw_points.
    """
    global buf, last_raw_points
...
def get_last_raw_points():
    """
    Returns the last parsed point cloud as a dict:
    { "x": [...], "y": [...], "z": [...], "v": [...] }
    Returns None if no points have been parsed yet.
    """
    global last_raw_points
    if not last_raw_points["x"]:
        return None
    return last_raw_points
